...
function nuevosPrecios(){  
    if($("#SLconvDivisas").val()!==""){
      $("#divCambioDivisas").html(
      `<span>Monto subtotal ${divisas[$("#SLconvDivisas").val()].cod}: ${(montoTotal+parseInt(montoDescuento))*(divisas[$("#SLconvDivisas").val()].valor)}</span>
      <span>Descuento aplicado ${divisas[$("#SLconvDivisas").val()].cod}: ${montoDescuento*(divisas[$("#SLconvDivisas").val()].valor)}</span>
